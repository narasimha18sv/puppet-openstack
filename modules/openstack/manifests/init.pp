...
class openstack (
  ...
  if $use_hiera {
    class { '::openstack::config':
      region                        => hiera(openstack::config::region),
      network_api                   => hiera(openstack::network::api),
      network_external              => hiera(openstack::network::external),
      network_management            => hiera(openstack::config::network_management),
      ...
      controller_address_api        => hiera(openstack::config::controller_address_api),
      controller_address_management => hiera(openstack::config::controller_address_management),
      storage_address_api           => hiera(openstack::config::storage_address_api),
      storage_address_management    => hiera(openstack::config::storage_address_management),
      mysql_root_password           => hiera(openstack::config::mysql_root_password),
      ...
      rabbitmq_hosts                => hiera(openstack::config::rabbitmq_hosts),
      rabbitmq_user                 => hiera(openstack::config::rabbitmq_user),
      rabbitmq_password             => hiera(openstack::config::rabbitmq_password),
      ...
      swift_password                => hiera(openstack::config::swift_password),
      swift_hash_suffix             => hiera(openstack::config::swift_hash_suffix),
